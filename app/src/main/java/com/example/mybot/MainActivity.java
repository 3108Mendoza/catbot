...
public class MainActivity extends AppCompatActivity {
    ...
    private void getResponse(String input) {
        String workspaceId = "{botcrm-oyka}";
        String urlAssistant = "https://dialogflow.googleapis.com/+workspaceId";
        String authentication = "AIzaSyCIpLE8Z-bPptKiTpM8-TjOw8HLXI1TMCc";
        ...
        AndroidNetworking.post(urlAssistant)
                ...
                .addHeaders("Authorization" + authentication)
